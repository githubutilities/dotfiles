...
TARGET_SUBLIME_SETTING_DIRECTORY=~/.config/sublime-text-3/Packages/User
...
SUBLIME_PACKAGE_CONTROL_FILE_PATH=~/.config/sublime-text-3/"Installed Packages"/"Package Control.sublime-package"
